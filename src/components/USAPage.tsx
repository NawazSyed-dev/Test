...
import { ArrowLeft, ShoppingCart, Package, FileText, Clock, MapPin, Phone, Mail, Users, Truck, Settings, Headphones, Monitor, CreditCard, Smartphone } from 'lucide-react';
...
const USAPage: React.FC<USAPageProps> = ({ onBack, onNavigate }) => {
  const tiles = [
    {
      id: 1,
      ...
      onClick: () => onNavigate?.('orders-operations')
    },
    {
      id: 2,
            ...
            <div className="flex items-center space-x-6">
              ...
              <div className="text-center">
                <h1 className="text-white font-bold text-lg tracking-wide">
                  US ENTERPRISE POS DEPLOYMENT SOLUTIONS
                </h1>
        ...
        <div className="max-w-7xl mx-auto px-6 py-8">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center">
              ...
              <div>
                <h1 className="text-3xl font-black text-gray-800">US Hardware Deployment</h1>
        ...
        <div className="bg-white/95 backdrop-blur-xl rounded-3xl p-10 shadow-2xl mb-12 border border-gray-200/50 relative overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="flex items-center mb-8">
              ...
              <div className="ml-8">
                <h2 className="text-4xl font-black text-gray-800 mb-3">US POS Hardware Deployment Center</h2>
                <p className="text-xl text-gray-600 font-medium">Comprehensive deployment services across all US states</p>
              </div>
            </div>
            ...
            <div className="mb-8 h-56 bg-gradient-to-br from-gray-50 via-white to-gray-50 rounded-2xl flex items-center justify-center border-2 border-gray-200/50 shadow-inner relative overflow-hidden">
              ...
              <div className="relative text-center z-10">
                <div className="flex items-center justify-center space-x-8 mb-6">
                  ...
                  <div className="w-28 h-24 bg-gradient-to-br from-blue-600 to-indigo-600 rounded-2xl flex items-center justify-center shadow-2xl hover:shadow-3xl transition-shadow duration-300">
                ...
                <div className="bg-white/90 backdrop-blur-sm px-6 py-3 rounded-full shadow-lg">
                  <p className="text-lg font-bold text-gray-700">US POS Terminal Systems & Hardware</p>
                </div>
              </div>
            </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          {tiles.map((tile) => {
            ...
            return (
              <div 
                key={tile.id}
                className="group bg-white/95 backdrop-blur-xl rounded-3xl p-8 shadow-2xl hover:shadow-3xl transition-all duration-500 border border-gray-200/50 hover:border-gray-300/50 cursor-pointer transform hover:-translate-y-2 relative overflow-hidden"
          ...
          <div className="relative z-10">
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-8">
              <div className="group flex items-center p-6 bg-gradient-to-br from-gray-50 to-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-200/50">
                <div className="w-16 h-16 bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl flex items-center justify-center mr-6 shadow-xl group-hover:shadow-2xl transition-shadow duration-300">
                  <Phone className="h-8 w-8 text-white" />
                </div>
                <div>
                  <p className="font-black text-gray-800 text-lg">24/7 Support</p>
                  <p className="text-gray-600 font-semibold">+1 (800) POS-HELP</p>
                </div>
              </div>
              ...
              <div className="group flex items-center p-6 bg-gradient-to-br from-gray-50 to-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-200/50">
                ...
                <div>
                  ...
                  <p className="text-gray-600 font-semibold">deploy-us@postech.com</p>
                </div>
              </div>
              ...
              <div className="group flex items-center p-6 bg-gradient-to-br from-gray-50 to-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-200/50">
                ...
                <div>
                  ...
                  <p className="text-gray-600 font-semibold">Dallas, TX 75201</p>
                </div>
              </div>
            </div>
            ...
            <div className="pt-8 border-t border-gray-200">
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  ...
                  <span className="text-gray-700 font-black text-lg">50+ Support Engineers</span>
                </div>
                <div className="flex items-center space-x-6 text-sm">
                  <span className="bg-blue-100 text-blue-800 px-4 py-2 rounded-full font-bold">🔧 Hardware Specialists</span>
